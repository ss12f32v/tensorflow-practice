...
with tf.variable_scope('conv1') as scope:
    ...
    #If padding == same ->out_height = ceil(float(in_height) / float(strides[1]))   
    #else if padding the == valid ->out_height = ceil(float(in_height - filter_height + 1) / float(strides[1]))
